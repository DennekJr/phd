    ...
    <div className="bg-[#FFFFFF] flex items-start justify-between !py-[18px] !gap-[41px]">
      <div className="flex flex-col max-w-[576px] items-start justify-start gap-[20px] !pl-[37px]">
          ...
          {timeline.map((item, index) => (
            <div key={index} className="flex items-center gap-[10px]">
              <Image
                ...
                height={20}
              />
              <p className="text-[#232427] text-[16px] !leading-[100%] font-semibold">
                {item.tracker}
              </p>
            </div>
          ))}
        ...
        <p className="text-[#232427] text-[16px] !leading-[120%] !tracking-[0.01em] font-light text-left">
          An evening mixer in Lekki, Lagos, offering a relaxed environment for
          emerging female scholars to connect with experienced PhD holders for
          mentorship and career advice.
        </p>
        <div className="flex items-center gap-[20px]">
          <YellowButton variant="primary">Register</YellowButton>
          <div className=" !px-[70px] !py-[20px]">
            <span className="text-[#232427] text-[16px] !leading-[16px] !tracking-[0.2px] font-extrabold text-center border-b-[2px] border-[#232427] transition-all duration-300 transform hover:cursor-pointer hover:scale-[1.02] hover:shadow-lg">
              View Details
            </span>
          </div>
        </div>
