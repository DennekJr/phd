...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-end w-full">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 w-full h-[100vh]">
        {/* Background Image */}
        <div
          className="w-full h-full bg-cover bg-no-repeat scale-140 md:scale-100 bg-[50%_60%]"
          style={{
      ...
      {/* Content */}
      <div className="relative bottom-[120px] z-10 container mx-auto !px-[20px] md:!px-[75px] py-20 ">
        <div className="max-w-[360px] md:max-w-[760px] mb-5">
          {/* Small heading */}
          ...
          {/* Main heading */}
          <h1 className="!text-[36px] md:!text-[60px] !leading-[100%] !tracking-[0%] font-bold text-white !mb-[10px] !md:mb-[20px] leading-tight">
            Nigerian Female
            <br />
            PHD Holders in
            <br />
          ...
          {/* Subtitle */}
          <p className="max-w-[546px] !text-[20px] md:!text-[24px] !leading-[100%] !tracking-[0%] !pb-[50px] font-light text-white">
            Empowering Nigerian Women in Academia for National Development
          </p>

          {/* CTA Button */}
          <YellowButton>JOIN US</YellowButton>
        </div>
      </div>
