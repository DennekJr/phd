...
export default function About() {
  const images = [
    ...
    },
    {
      ...
      alt: "Nigerian female academic 2",
      width: 347,
      height: 231,
    },
    {
      src: "/images/about/image-three.jpg",
      alt: "Nigerian female academic 3",
      width: 372,
      height: 558,
    },
  ];
  ...
  const ideals = [
    {
      title: "Our Mission",
      description:
        "To promote academic excellence for Nigerian females towards the socioeconomic development of Nigeria.",
    },
    {
      title: "Our Motto",
      ...
      <div className="relative mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <h2 className="font-bold whitespace-nowrap max-w-[709px] lg:!text-[48px] !text-[30px] !leading-[120%] !tracking-[0%] text-[#222121] !mt-[10px] !mb-[26px]">
              Fostering
              <br />
            ...
            <div className="!space-y-[20px] lg:flex hidden flex-col">
              {ideals.map((item, i) => (
          ...
          <div className="!space-y-[20px] relative order-3 lg:hidden flex flex-col">
            {ideals.map((item, i) => (
              <div key={i} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                <div className="relative border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1">
