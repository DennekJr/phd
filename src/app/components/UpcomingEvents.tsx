  ...
  const events = [
    {
      ...
      description:
        "A full-day symposium showcasing cutting-edge research by Nigerian female PhD holders across various disciplines.",
    ...
    },
    {
      ...
      description:
        "An online workshop providing practical strategies and insights for Nigerian female academics seeking international research grants.",
    ...
    },
    {
      ...
      time: "7:00 pm",
      title:
        "Online Professional Development Series: Publishing in High-Impact Journals",
      description:
        "A virtual session offering practical advice and strategies for Nigerian female PhD holders aiming to publish their research in reputable international journals.",
    ...
    },
    {
      ...
      description:
        "Description: An elegant evening in Lagos celebrating academic achievements and recognizing our annual scholarship recipients. Features a keynote address and networking opportunities.",
      image: "/images/upcoming-events/event-three.jpg",
    },
  ];

  return (
    <section className="relative flex items-center justify-center bg-[#161617] !pt-[45px] lg:!pt-[128px] !pb-[135px] !px:-[20px] lg:!px-[100px] xxl:!px-[204px]">
      {/* Decorative arrow */}
      <div className="mx-auto !px-[10px] relative max-w-[1920px]">
        {/* Header */}
        {!showAllEvents && (
        ...
        <div className="space-y-12 ">
          {events
            ...
            .map((event, index) => (
              <div
                key={index}
                style={{ paddingTop: index === 0 ? "0px" : "40px" }}
                className="flex items-start gap-8 transition-colors duration-300 !pb-[40px] border-b border-[#454545]"
              >
                {/* Date Block */}
                <div className="!py-[20px]">
                  <div className="bg-[#AD0000] text-white text-center w-[102px] h-[78px] flex flex-col justify-center">
                    <div className="text-[14px] font-medium !leading-[100%] !tracking-[0%]">
                      {event.date.month}
                    </div>
                    <div className="text-[32px] font-bold !leading-[100%] !tracking-[0%]">
                      {event.date.day}
                    </div>
                  </div>
                ...
                <div className="flex-shrink-0 md:block hidden">
                  <div className="relative w-[331px] h-[203px]">
                    ...
                    {/* <Image
                      ...
                      width={331}
                      height={203}
                      className="absolute inset-0 w-[331px] h-[203px] z-0 pointer-events-none"
                    /> */}
                    {/* Event image - positioned behind the card frame */}
                    <div className="absolute inset-[15px] z-15">
                      <Image
                        src={event.image}
                        alt={event.title}
                        width={331}
                        height={203}
                        className="w-full md:w-[331px] h-[203px] h-full object-cover"
                      />
                    </div>
                  </div>
                </div>
