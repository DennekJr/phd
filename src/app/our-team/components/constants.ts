...
export const AssociateFounderTrustees = [
    {
        ...
        info: formatMultiLineString(`
            Professor Chioma Ikeanyionwu is a highly accomplished educator, researcher, and academic leader. She is a Chief Lecturer at the Federal College of Education (Technical) in Umunze, Anambra State, Nigeria, where she has demonstrated unwavering commitment to academic excellence. 
